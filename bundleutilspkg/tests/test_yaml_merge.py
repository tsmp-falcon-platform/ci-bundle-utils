...
def test_merge_yaml_files(merger, test_dir):
    _test_merge_yaml_files(
        merger, test_dir, "expected.yaml", "parent.yaml", "child.yaml"
    )
...
def test_merge_yaml_plugin_files_parent(merger, test_dir):
    _test_merge_yaml_files(
        merger, test_dir, "plugins/expected-parent.yaml", "plugins/parent.yaml"
    )
...
def test_merge_yaml_plugin_files_child(merger, test_dir):
    _test_merge_yaml_files(
        merger,
        test_dir,
        "plugins/expected-parent-child.yaml",
        "plugins/parent.yaml",
        "plugins/child.yaml",
    )
...
def test_merge_yaml_plugin_files_grandchild(merger, test_dir):
    _test_merge_yaml_files(
        merger,
        test_dir,
        "plugins/expected-parent-child-grandchild.yaml",
        "plugins/parent.yaml",
        "plugins/child.yaml",
        "plugins/grandchild.yaml",
    )
